...
while [[ $NEXTCLOUDSERVERNAME == '' ]]
do
read -p "Enter your absolute Nextcloud datapath (mydommain.com): " NEXTCLOUDSERVERNAME
if [[ -z "$NEXTCLOUDSERVERNAME" ]]; then
echo "Nextcloud server must not be empty!"
echo""
else
echo "Your Nextcloud server name: "$NEXTCLOUDSERVERNAME
fi
